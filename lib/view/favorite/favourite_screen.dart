          ...
          : _products == null || _products!.isEmpty
              ...
              : GridView.builder(
                  padding: const EdgeInsets.only(
                      left: 16,
                      right: 16,
                      bottom: 100), // Add space at the bottom
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: <Widget>[
            TextButton(
              onPressed: () {
                Navigator.of(context).pop(); // إغلاق الحوار بدون إرسال
              },
              child: const Text("Cancel"),
            ),
            TextButton(
              onPressed: () {
                // هنا يمكنك إرسال العدد (مثل حفظه أو إرساله إلى API)
                Navigator.of(context).pop(); // إغلاق الحوار بعد الإرسال
              },
